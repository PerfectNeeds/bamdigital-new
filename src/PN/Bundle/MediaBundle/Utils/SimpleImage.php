...
namespace PN\Bundle\MediaBundle\Utils;
...
class SimpleImage
{
    ...
    public static function saveNewResizedImages($imagePath, $newImagePath, $maxWidth, $maxHeight, $optimization = 75, $bigImagePath = null, $bigImageMaxWidth = 0, $bigImageMaxHeight = 0)
    {
