...
use PN\Bundle\SeoBundle\Entity\Redirect404;
use PN\Bundle\SeoBundle\Form\Redirect404Type;
...
class Redirect404Controller extends Controller
{
     ...
     *
     * @Route("/", name="redirect404_index")
     * @Method("GET")
     */
    public function indexAction()
    {

        return $this->render('SeoBundle:Administration/Redirect404:index.html.twig');
     ...
     *
     * @Route("/new", name="redirect404_new")
     * @Method({"GET", "POST"})
     */
    public function newAction(Request $request)
    {
        ...
        return $this->render('SeoBundle:Administration/Redirect404:new.html.twig', array(
     ...
     *
     * @Route("/{id}/edit", name="redirect404_edit")
     * @Method({"GET", "POST"})
     */
    public function editAction(Request $request, Redirect404 $redirect404)
    {
        ...
        return $this->render('SeoBundle:Administration/Redirect404:edit.html.twig', array(
            'redirect404' => $redirect404,
     ...
     *
     * @Route("/{id}", name="redirect404_delete")
     * @Method("DELETE")
     */
     ...
     *
     * @Route("/data/table", defaults={"_format": "json"}, name="redirect404_datatable")
     * @Method("GET")
     */
    public function dataTableAction(Request $request)
    {
        ...
        $count = $em->getRepository('SeoBundle:Redirect404')->filter($search, TRUE);
        $redirect404s = $em->getRepository('SeoBundle:Redirect404')->filter($search, FALSE, $start, $length);

        return $this->render("SeoBundle:Administration/Redirect404:datatable.json.twig", array(
                "recordsTotal" => $count,
